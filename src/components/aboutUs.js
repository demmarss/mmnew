                ...
                <Hero>
                    <Hero.Body>
                        <Container>
                            ...
                            <Columns>
                                <Columns.Column size="is-one-half">
                                    <Tile kind="parent">
                                        <Tile renderAs="article" kind="child" notification color="info">
                                            <Heading>Our Mission</Heading>
                                            <hr/>
                                            <Heading className="subtitle is-3">The Moorhead-Fargo Islamic Community Center (MFICC).......</Heading>
                                            <ul>
                                ...
                                <Columns.Column size="is-one-half">
                                    <Tile kind="parent">
                                        <Tile renderAs="article" kind="child" notification color="warning">
                                            ...
                                            <hr/>
                                            <Heading className="subtitle is-3">MFICC aims .....</Heading>
                                            <ul>
