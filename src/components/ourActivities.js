                            ...
                            <Columns.Column size="one-third">
                                <Card>
                                    <Card.Image size="4by3" src={dawah1} />
                                        <p class="title is-4 no-padding">Islamic Class</p>
                                    <Card.Content>
                                        <Content>
                                            <p class="subtitle is-6">Quran, 39:9</p>
                                            <p>"Are those who have knowledge and those who have no knowledge alike? Only the men of understanding are mindful." </p>
                                            <hr/>
                                            <p class="subtitle is-6">Quran 96:105</p>
                            ...
                            <Columns.Column size="one-third">
                                <Card>
                                    <Card.Image size="4by3" src={dawah5} />
                                        <p class="title is-4 no-padding">Community Dawah</p>
                                    <Card.Content>
                                        <Content>
                                            <p class="subtitle is-6">An-Nahl 16:125</p>
                                            <p>“Invite to the path of your Lord with wisdom and good advice”.</p>
                                            <br/>
                                            <hr/>
                                            <p class="subtitle is-6">Aal `Imran 3:104</p>
